...
//         <div style={{backgroundImage:`url(${prodigy1})`}} className='relative pb-15 pt-4 h-full min-w-full'>
//             <div className='flex justify-center absolute top-10 left-1/2 transform -translate-x-1/2'><img src={logo} alt="" /></div>
//             <div className='my-10 flex justify-center'>
//                 <img src={prodigylogo} alt="" />
//             </div>
...
//                 </p>
//             </div>
//             <div className='w-full absolute top-0 left-0 right-0'><img src={prodigytop} alt="" /></div>
//             <div className='w-full absolute bottom-0 left-0 right-0'><img src={prodigyfoot} alt="" /></div>
...
//                 <img src={vid} alt="" className='md:px-4 h-80' />
//                  <FaPlay onClick={()=>setOpen(true)} className='absolute top-1/2 left-36 transform -translate-y-1/2   text-white text-4xl bg-green-400 px-8 hover:bg-[#0dcaf0] cursor-pointer  rounded-full h-20 w-20 z-10 ' />
...
//                 <img src={prodigypartner} alt="" className='h-10 w-fit' />
//                 <p className='text-center text-white font-semibold max-w-xl'>
...
//                 </p>
//                 <p className='text-center text-white font-semibold max-w-xl'>They also got the amazing opportunity to meet with both the Microsoft Minecraft team and the Microsoft MakeCode team, as well as engage in conversations with other esteemed teams such as XBOX, Bing and AI.
//             </p>
//             <p className='text-[#51b8ff] font-semibold text-lg text-center max-w-xl'>
...
//       <button
//         className="w-10 h-10 flex items-center justify-center bg-green-500 text-white rounded-full"
//       >
